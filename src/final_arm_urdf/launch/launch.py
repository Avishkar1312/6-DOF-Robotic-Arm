...
def generate_launch_description():
    ...
    package_dir = get_package_share_directory('final_arm_urdf')
    ...
    declare_urdf_cmd = DeclareLaunchArgument(
        'urdf_file',
        default_value=os.path.join(package_dir, 'urdf', 'final_arm_urdf.xacro'),
    ...
    start_joint_state_publisher_cmd = Node(
        ...
        package='joint_state_publisher_gui_custom',
        executable='joint_state_publisher_gui_custom',
